    ...
    return (
        <footer className="bg-background rounded-lg shadow m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span classNameName="block text-sm text-gray-500 sm:text-center dark:text-gray-400"><Link href="https://www.linkedin.com/company/imaginemsu/" class="hover:underline">Made by Imagine Software</Link> </span>
            </div>
        </footer>
    );
}
