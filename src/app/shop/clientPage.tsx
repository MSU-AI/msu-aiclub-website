...
import PointsBanner from '~/components/shop/points-banner';
import RedemptionDrawer from '~/components/shop/redemption-drawer';
import type { User } from '@supabase/supabase-js';

interface ShopPageClientProps {
  user: User | null;
  points: { totalPoints: number; visiblePoints: number } | null;
  redeemablePoints: number;
}

export default function ShopPageClient({ user, points, redeemablePoints }: ShopPageClientProps) {
  ...
  return (
    <div className="max-w-screen-lg mx-auto pt-24 px-4 pb-16">
      ...
      {/* Points Banner - Only show for authenticated users */}
      {user && (
        <PointsBanner 
          onOpenRedemption={openRedemption} 
          user={user}
