  ...
  return (
    <div className="flex flex-col items-center justify-center p-10 text-white gap-12 min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center w-[40rem] h-40 relative">
        ...
        <p className="text-2xl sm:text-lg"> The hub for everything AI at MSU </p>
        </div>
    ...
    <div className="overflow-hidden rounded-md flex flex-col antialiased bg-background dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
      <InfiniteMovingCards
        direction="right"
        speed="slow"
      />
